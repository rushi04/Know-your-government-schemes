...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation">
	...
	<!-- PageBanner2 -->
	<div class="container-fluid no-padding pagebanner2">
		<div class="container">
			<div class="pagebanner2-content">
				<h3>Scholarships</h3>
				<!--<ol class="breadcrumb">
	...
	<div class="container welcome-section welcome2">
		...
		<div class="search-result">
			<span>Showing Scholarships Available</span>
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship1.jpg" alt="welcome1" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Savitri Bai Scholarship for Womens</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship2.jpg" alt="welcome2" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Azad Hind Medhavi Yozana</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship3.jpg" alt="welcome3" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Jawaharlal Nehru Merit Scholarship</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship4.png" alt="welcome4" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Madhya Pradesh Medhavi Yojana</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship5.jpg" alt="welcome5" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Maharashtra State Post Metric Scholarship</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship6.png" alt="welcome6" style="width:400; height:350px; "/>
					<div class="welcome-title">
						<h3>Atal Bihari Vajpayee Scholarship</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship7.jpg" alt="welcome7" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Andhra Pradesh Merit Scholarship</h3>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship8.jpg" alt="welcome8" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Army Scholarship</h3>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/scholarship9.jpg" alt="welcome9" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Air Force Student Scholarship</h3>
					</div>
				</div>
			</div>
		</div>
