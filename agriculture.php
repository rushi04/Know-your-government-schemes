		...
		<div class="row">
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images.jpg" alt="welcome1" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Din Dayal Grameen Kaushalya Yojana</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images1.jpg" alt="welcome2" style="width:400; height:350px;"/>
					<div class="welcome-title">
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images2.jpg" alt="welcome3" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Pradhan Mantri Gramin Awas Yojana</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images4.jpg" alt="welcome5" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Land Development Policy</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images5.jpg" alt="welcome6" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Rajeev Gandhi Grameen Vidyutikaran Yojana</h3>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images6.jpg" alt="welcome7" style="width:400; height:350px;"/>
					<div class="welcome-title">
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images7.jpg" alt="welcome8" style="width:400; height:350px;"/>
					<div class="welcome-title">
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				<div class="welcome-box">
					<img src="images/images8.jpg" alt="welcome9" style="width:400; height:350px;"/>
					<div class="welcome-title">
						<h3>Farmers Loan Schemes</h3>
					</div>
